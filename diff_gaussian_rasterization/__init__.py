...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, alpha, radii, geomBuffer, binningBuffer, imgBuffer, invdepths = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, alpha

    @staticmethod
    def backward(ctx, grad_out_color, _, grad_out_depth, alpha):
